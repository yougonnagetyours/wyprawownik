---
name: project-flota-aut
description: "Stan floty na 14.08.2026: Terrano sprzedane, jedyne auto na chodzie to Passat B5.5 z niezdiagnozowaną uszczelką, docelowo kupujemy B7 4motion."
metadata:
  node_type: memory
  type: project
...
**How to apply:**
- Domyślne auto wyjazdowe = **B7, którego jeszcze nie ma**. Przy planowaniu wyprawy zapytaj wprost, czym jadą, zanim policzysz paliwo
- **Nie zakładaj Terrano w żadnym planie ani budżecie.** Stare budżety wypraw liczone na Terrano (12 L/100 km) są nieaktualne
- B5.5 = backup i daily, nie auto na wyprawę. Nie pchaj w niego upgradów — patrz [[feedback-droga-nie-sprzet]]
- Pliki: `auta/passat-b5.5/stan.md`, `zakup-passata-b7.md`. Stan zawsze rozstrzyga `active-state.md`
