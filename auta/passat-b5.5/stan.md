...
| Napęd | przód |
| Przebieg | **~430 000 km** (akt. 08.09.2026) |
...
- [ ] **🆕 POMPA WSPOMAGANIA — zaczyna wysiadać (zgłoszone 07.09.2026).** Objaw wg Michała: pompa „zaczęła wychodzić". **Zanim wymiana — trzy tańsze przyczyny dające ten sam objaw:** (1) **poziom płynu** w zbiorniczku na zimnym — za mało = pompa łyka powietrze i wyje, 0 zł; (2) **przewód ssący / niskiego ciśnienia** — potrafi zasysać powietrze BEZ widocznego wycieku na zewnątrz, klasyk udający padniętą pompę; (3) **pasek wielorowkowy i napinacz** — ślizgający się pasek daje to samo, a przy 424 tys. km jest kandydatem sam z siebie.
  ⚠️ **Płyn: VW G 002 000 / CHF 11S (zielonkawy syntetyk hydrauliczny), NIE ATF.** ATF rozwala uszczelnienia — dopytać mechanika, co leje.
  **Koszt SZACUNEK (niesprawdzone u źródła):** pompa z demontażu 200–400 · regenerowana 400–800 · nowy zamiennik 600–1 200 · robocizna 200–400. Inna liga niż głowica.
  **Łączenie z wizytą:** pompa jest obojętna na temperaturę auta, uszczelka nie → **kolejność w warsztacie: najpierw pakiet uszczelkowy na ZIMNYM (tester na szyjce przed odpaleniem), pompa oglądana po tamtym.**
...
**Stanowisko mechanika po rozmowie telefonicznej:**
- **Nie sądzi, że to uszczelka** — argument: auto nie grzeje się nawet w korkach i po mieście przy ~40°C. Zgodne z obserwacją z 28.06 i z hipotezą taty.
- **Nie ma testera CO2.** Michał może kupić własny i zrobić sam (SZACUNEK 100–250 zł za zestaw z barwnikiem).
- **Radzi wymienić płyn chłodniczy** (dawno niewymieniany) i obserwować: jeśli świeży znowu ściemnieje → to jest dopiero oznaka. Koszt wymiany ≈ koszt testera.
- **Tłumaczy „pszt" po 2 dniach postoju małą ilością płynu** — układ musiał się „wyrównać".
- **Wspomaganie:** zlać, przepłukać układ, wlać właściwy płyn VW („nie wolno takich cudów wlewać"). Robił to samo koledze w B5 z identycznymi objawami (straszne wycie) — po wymianie i przepłukaniu śmiga do dziś, 2 lata.

**⚖️ Ocena tych argumentów:**

| Argument mechanika | Werdykt |
|---|---|
| Wspomaganie: płyn + przepłukanie zamiast pompy | ✅ **Kupujemy w całości.** Najtańszy trop, historia z B5 kolegi wiarygodna. Zastrzeżenie: jeśli płynu UBYŁO, znaleźć skąd |
| Wymiana płynu jako punkt odniesienia | ✅ **Bardzo dobre.** Zamienia ocenę „na oko" (wartą tyle co „różowy" taty) w twardy test: świeży płyn, który znów ciemnieje, nie ma innego wytłumaczenia. Kasuje też hipotezę taty o starym płynie |
| „Nie grzeje się w upale = raczej nie uszczelka" | ✅ Spójne z 28.06. Wyklucza **rozwiniętą** uszczelkę — nie wyklucza małej/wczesnej ani chłodnicy EGR |
| **„Pszt po 2 dniach = było mało płynu"** | ⚠️ **Tłumaczy tylko JEDEN kierunek.** Działa, jeśli powietrze **wchodzi** (podciśnienie, mało płynu, zawór w korku nie oddaje). **Nie działa, jeśli wychodzi** — w zimnym aucie nic nie podgrzewa płynu, a powietrze samo z siebie nie robi ciśnienia. **Rozstrzyga darmowy test gumy, nie dyskusja** |
| Skąd w ogóle ubyło płynu? | ❓ **Nie zapytał.** Mało płynu to nie przyczyna, tylko kolejny objaw. Przy 424 tys. km i płynie nigdy niewymienianym powolne ubywanie przez lata jest normalne — ale trzeba to powiedzieć wprost, nie założyć |

**🔁 KOLEJNOŚĆ — nie da się odwrócić (ważne):**
1. **Darmowe testy NAJPIERW** (guma rano + balonik przez noc), dopóki układ jest nieruszony
2. **Zdjęcie zbiorniczka** przed spuszczeniem — punkt odniesienia do porównania koloru
3. **Dopiero potem wymiana płynu**

Świeżo napełniony układ jest zapowietrzony i przez kilka tygodni daje mylące wyniki na gumie i baloniku. Do 17.09 jest 9 dni luzu — mieści się bez pośpiechu.

⚠️ **Płyn: G12+/G13 (różowy/fioletowy), NIE zielony G11.** Mieszanie tych rodzin robi żel.

**📌 Do dopytania 17.09 — dwie rzeczy, o które trzeba się upomnieć samemu:**
1. **LEAK-DOWN** — inne narzędzie niż tester CO2 (sprężarka + przejściówka po świecy żarowej, większość warsztatów ma). **Jedyny test odróżniający głowicę 3–4 tys. od chłodnicy EGR 600–1 500.** Cztery cylindry szczelne + zasyfiony płyn = chłodnica EGR
2. **„Nie odpalaj od razu"** — auto przyjedzie rozgrzane po 9:00. Test ciśnienia na zimnym układzie ma sens dopiero po wystygnięciu. Skoro auto stoi cały dzień, nic to nie kosztuje, ale sam z siebie tego nie zrobi

**❌ BALONIK ODWOŁANY (08.09.2026) — dwa trafne zarzuty Michała:**
...
**Uszczelki się nie naprawia, tylko wymienia.** Robota jest zawsze ta sama, niezależnie od skali przedmuchu: zdjęcie głowicy → sprawdzenie płaszczyzny na stole → planowanie, jeśli krzywa → nowa uszczelka → **nowe śruby TTY** (jednorazowe, rozciągają się przy dokręcaniu) → rozrząd przy okazji, bo i tak rozebrane. To są te **2 500–4 000 zł** z tabeli niżej i nie da się z tego zrobić 800 zł.

Przy mikroprzedmuchu są więc **trzy** drogi, nie jedna:

| Droga | Kiedy ma sens |
|---|---|
| **Jeździć i obserwować** ← **domyślna dla tego auta** | Nie grzeje się, płyn nie ubywa. Przy aucie wartym 5–8 tys. z 430 tys. km to **normalna decyzja, nie olewanie**. Pilnować poziomu i temperatury, wymieniać płyn częściej |
| Wymiana uszczelki | Dopiero gdy zacznie **ubywać płynu** albo **pełzać temperatura** |
| Uszczelniacz chemiczny (K-Seal itp.) | Ostateczność. Czasem trzyma miesiącami, ale **potrafi zapchać nagrzewnicę i chłodnicę** — dwa problemy zamiast jednego |
...
**🛒 TESTER CO2 — CENY SPRAWDZONE U ŹRÓDŁA 08.09.2026 (korekta: wcześniejszy SZACUNEK 100–250 zł był zawyżony o rząd wielkości):**

| Sklep | Cena | Zestaw |
|---|---|---|
| [AMD Tools](https://amdtools.pl/testery-szczelnosci-uszczelek-glowicy/tester-uszczelki-pod-glowica-co2-plyn-zestaw-test) | **27,99 zł** | rurka + **100 ml płynu (~50 testów)** + **adapter stożkowy 25–55 mm** |
| [BAU-TEC](https://bau-tec.pl/pl/p/TESTER-SZCZELNOSCI-USZCZELKI-GLOWICY-CO2-ADAPTERY/1777) | 35,77 zł (chwilowo niedostępny) | to samo + **6 korków** (29–33, 37–41, 40–43, 44–48, 48–51, 50–54 mm) |
| [BETA 1758VT](https://beta-narzedzia.pl/zestaw-do-wykrywania-co2-w-ukladzie-chlodzenia-beta-1758vt.html) | ~618 zł brutto | wersja warsztatowa — **nie dopłacać**, chemia identyczna |

**Rekomendacja: wersja z adapterem STOŻKOWYM 25–55 mm**, nie z korkami — jeden stożek obejmuje cały zakres, nie trzeba z góry znać średnicy szyjki zbiorniczka.

**🚩 Trzy rzeczy, żeby nie zmarnować testu:**
1. **W DIESLU barwnik zmienia się na ZIELONY, nie żółty.** Żółty = benzyna/LPG. Czekanie na żółty = przegapiony wynik pozytywny
2. **Silnik musi PRACOWAĆ i być przegazowywany.** Zimne auto → zdjąć korek → tester na szyjkę → **dopiero teraz odpalić** → odczyt przy dochodzeniu do temperatury i na gazie. Na zimnym stojącym silniku test nie działa
3. **Nie zassać płynu do rurki** — tester trzymany nad szyjką, nie zanurzany

**Tester CO2 — kupować dopiero PO darmowych testach.** Wielokrotnego użytku, można powtarzać po miesiącu. Ale: **pozytywny = pewny, negatywny NICZEGO nie wyklucza** (brat robił na pękniętej głowicy — nie wykrył). Nie zamknie tematu na „nie".
...
**✅ WYNIK TESTU A (guma chłodnicy) — 08.09.2026: BEZ RÓŻNICY, guma plastyczna przed i po.**

Michał ścisnął górną gumę przed odkręceniem korka i zaraz po — **to samo wrażenie, guma dająca się ścisnąć w obu przypadkach**. To wiersz „zdrowo" z tabeli niżej: **w zimnym układzie nie ma ani nadciśnienia, ani podciśnienia**.

**Co to daje:**
- ❌ **Osłabia nadciśnienie** — czyli w tym momencie nic nie wytwarzało gazu. Argument przeciw uszczelce, chłodnicy EGR i dogrzewaczowi (choć **nie wyklucza małej / okresowej nieszczelności** — mogło nie zdążyć się nazbierać)
- ❌ **Osłabia też wersję mechanika** („mało płynu, układ się wyrównywał") — podciśnienie zassałoby gumę do środka, a nie zassało
- ✅ Zostaje **balonik przez noc** jako jedyny rozstrzygający: mówi, czy gaz **przybywa**, a nie tylko co jest w układzie w danej chwili

⚠️ **Do potwierdzenia przy okazji:** czy auto stało od poprzedniego wieczora (zimne) i **czy w ogóle było „pszt"** przy odkręcaniu korka tego dnia. Brak „pszt" byłby osobną, mocną informacją — objaw z 22.05 mógł być okresowy.
...
**🔥 DOGRZEWACZ (WEBASTO / EBERSPÄCHER) — TRZECI PODEJRZANY, podniesiony przez mechanika 07.09.2026:**

Mechanik wspomniał o „podgrzewaczu paliwa" jako alternatywie dla uszczelki. **Mylące określenie** — chodzi o urządzenie, które **spala paliwo, żeby podgrzać płyn chłodniczy**: dogrzewacz / ogrzewanie postojowe (Webasto, Eberspächer). W 1.9 TDI montowany dlatego, że silnik zimą grzeje kabinę słabo. Wygląd: metalowy walec ~20 cm, własna dysza, świeca i **własny mały wydech**.

**Dlaczego daje ten sam objaw:** ma komorę spalania oddzieloną **cienką ścianką od płynu chłodniczego** — dokładnie ten sam układ co chłodnica EGR. Pęknięta ścianka = **spaliny w płynie**: ciśnienie w zbiorniczku, wzburzanie, ciemnienie płynu. Nie do odróżnienia od uszczelki bez odizolowania.

**Czemu to dobra wiadomość:** dogrzewacz to komfort, nie mechanika. Jeśli to on — **wypiąć z obiegu i zamknąć przewody w pętlę**. Tracisz funkcję, której Michał i tak nie używa, silnik zdrowy, robota ~30 min. **Najtańszy z całej trójki.**

**Czy to auto go w ogóle ma — do sprawdzenia (była to OPCJA, nie standard):**
1. **Pod przednim zderzakiem, częściej z lewej** — walec ~20 cm, cienka rurka wydechowa w dół, przewody płynu + cienki przewód paliwa
2. **Spod auta z przodu** — drugi, mały wylot spalin oprócz głównego z tyłu
3. **Najpewniej: VCDS, adres 18 (Zusatzheizung)** — moduł odpowiada = auto go ma. Minuta roboty

**Test 17.09:** zacisnąć / wypiąć dwa przewody płynu dogrzewacza i **powtórzyć test ciśnienia**. Ciśnienie znika → sprawa zamknięta bez ruszania głowicy. Ten sam manewr co przy chłodnicy EGR, tylko tańszy.

⚠️ **Nie mylić z grzałką filtra paliwa** — elektryczna, żeby ON nie żelował zimą. **Zero kontaktu z płynem chłodniczym, nie może wywołać tego objawu.** Jeśli mechanik mówił o niej, to fałszywy trop.
...
**🚨 ZMIANA STANU 08.09.2026 — PŁYN ZACZĄŁ UBYWAĆ**

Wcześniej: przez cały sezon jazdy na pełnej klimie **płyn nie ubywał** — to był główny argument przeciw uszczelce, powtarzany przez Michała, tatę i mechanika. **Teraz Michał zauważył lekki ubytek.** Ten argument przestał obowiązywać. To realna zmiana, nie drobiazg.

**Ale powolny ubytek najczęściej NIE jest uszczelką.** Kolejność od najczęstszego:
1. **Wyciek zewnętrzny** — przewody i opaski, **plastikowa obudowa termostatu** (klasyk w tych silnikach), szew chłodnicy, **pęknięty zbiorniczek wyrównawczy** (typowe w B5), otwór kontrolny pompy wody
2. **Nieszczelny korek** — nie trzyma 1,4 bara, płyn odparowuje przy nagrzaniu. **22 lata, już zamawiany**
3. **Nagrzewnica w kabinie** — patrz niżej
4. Dopiero potem uszczelka / chłodnica EGR

**❄️ Pytanie Michała o ogrzewanie:** płyn płynie przez nagrzewnicę **zawsze**, niezależnie od ustawienia. Pokrętło steruje klapą powietrza, nie przepływem płynu. Włączenie ogrzewania samo z siebie nie powoduje ubytku — ale przy cieknącej nagrzewnicy zaczynasz to **czuć**, bo dmuchawa rozwiewa opary.

**📝 ODPOWIEDZI MICHAŁA 09.09.2026 — trzy rzeczy rozstrzygnięte:**

1. **Dywanik pachnie WILGOCIĄ, nie słodko** → ❌ **nagrzewnica spada na dół listy.** Zostaje hipoteza z maja: zapchane odpływy pod podszybiem. Płyn ucieka gdzie indziej
2. **Przy pasku SZŁY rolki i pompa wody, pasek dobrej marki** → ✅ zestaw kompletny, temat zamknięty. **Wymiana „dla pewności na jesień 2026" NIE MA SENSU** — pasek jest w połowie życia (~40 tys. km, 3,5 roku), a to ponad tysiąc zł wyrzucone rok przed terminem, przy niesfinansowanej jeszcze zagadce z płynem. Oględziny 17.09, wymiana wiosna 2027. Wyjątek: gdyby głowica schodziła
3. **🟢 Ubytek płynu NIE występował w upały i na klimie — zaczął się dopiero teraz, gdy chłodniej.** **To argument PRZECIW uszczelce:** przedmuch spalin rośnie z obciążeniem i temperaturą, więc przy 38°C z klimą pod korek powinno być najgorzej. Było odwrotnie. Dodatkowo przy klimie wentylator chłodnicy chodzi częściej → układ pracuje chłodniej. Pasuje do **zmęczonego korka albo drobnego wycieku zewnętrznego**, wrażliwego na wahania temperatury

**📏 PROTOKÓŁ POMIARU UBYTKU (bo „raz więcej, raz mniej" to pomiar temperatury, nie ubytku):**
- **Zawsze na ZIMNYM**, po nocy postoju — płyn rozszerza się o kilka mm przy nagrzaniu
- **Zawsze w tym samym miejscu, na płaskim**
- **Metoda wybrana przez Michała (10.09): dolać tuż pod kreskę MAX i obserwować** — kreski na zbiorniczku są dobrze widoczne, znacznik nic nie dodaje. ✅ OK. **Uzupełnienie: przy dolewce zrobić ZDJĘCIE telefonem.** Za tydzień porównuje się dwa zdjęcia zamiast wrażenia — a to wrażenie mówiło „raz więcej, raz mniej"
- **Tydzień pomiaru** → do mechanika idziesz z „ubyło 3 mm" albo „ubyło 2 cm". To dwie zupełnie różne rozmowy

**🔎 DARMOWE ZADANIE: czy mokro w kabinie to woda, czy płyn chłodniczy?**

Mokre dywaniki i zaduch wiszą w pliku od maja, przypisane zapchanym odpływom pod podszybiem. Cieknąca nagrzewnica daje **to samo + ubytek płynu**. Różnicowanie za 0 zł:

| Objaw | Odpływy pod podszybiem | Nagrzewnica |
|---|---|---|
| Kiedy mokro | **Tylko po deszczu** | Też po tygodniu suszy |
| Zapach | Stęchlizna, pleśń | **Słodkawy** |
| Szyba od środka | Normalna | **Tłusty, trudny do zmycia film** |
| Ciecz na dywaniku | Woda | **Śliska, lekko różowa** |

Opis Michała mówił „zwłaszcza po deszczu” → przemawia za odpływami. **Ale przy ubywającym płynie trzeba sprawdzić ponownie.**

**Najtańsze znalezienie wycieku:** ten sam **test ciśnienia 1,4 bar** planowany na 17.09 — pompka na zimny układ, trzymasz i szukasz kropli. Alternatywa: **barwnik UV do płynu (~30 zł) + lampka** — świeci dokładnie w miejscu ucieczki.

**💰 Kontekst decyzji „włożyć 4–5 tys. zamiast kupować” (Michał, 08.09):** logika jest sensowna — znane auto z historią i już wsadzonymi 3 tys. kontra nieznane za 17–25 tys., przy płytkim rynku kombi+manual+4x4. **Warunek: najpierw diagnoza.** 4–5 tys. w głowicę ma sens tylko jeśli to głowica; przy korku i przewodzie wydajesz 200 zł, przy pękniętym bloku nie wydajesz nic i sprzedajesz. Ta sama diagnostyka (~60 zł + wizyta) rozstrzyga wszystkie trzy scenariusze.

### 🌍 PRZYGOTOWANIE NA DŁUGĄ TRASĘ (Chorwacja / Bałkany) — lista z 08.09.2026

⚠️ **Kontekst, który zmienia wagę tej listy:** zakup drugiego auta jest **wstrzymany**, a Bałkany X.2026 (oświadczyny) są za ~miesiąc. Jeśli B5.5 ma być autem wyprawowym, a nie backupem — poniższe przestaje być „kiedyś", a robi się „przed wyjazdem". **Do potwierdzenia z Michałem.**

**🔴 BLOKUJĄCE — bez tego nie ma wyjazdu**

| Pozycja | Dlaczego | Koszt (SZACUNEK, niesprawdzone u źródła) |
|---|---|---|
| ~~**ROZRZĄD**~~ → **ZDJĘTY Z LISTY BLOKUJĄCEJ 09.09.2026** | ⚠️ **SPROSTOWANIE: NIE jest przeterminowany.** Wcześniejszy zapis był bezpodstawny — nikt nie zna przebiegu od wymiany. Interwały sprawdzone u źródła: [TDI-Tuning](https://tdi-tuning.pl/co-ile-wymiana-rozrzadu-w-1-9-tdi-kilometry-i-czas/) i [jakjezdzisz.pl](https://jakjezdzisz.pl/co-ile-wymieniac-rozrzad-19-tdi-poradnik) → **90–120 tys. km albo ~5 lat**, zachowawczo 60–80 tys.; Contitech (dostawca OE dla VAG) → **90 tys. km**; VW dla MY2004+ ([blauparts](https://www.blauparts.com/blog/vw-tdi-timing-belt-interval-chart.html)) → ~128 tys. km **lub 48 mies.** Wymiana ~3 lata temu = **Michał jest PRZED terminem**, zgodnie z tym, co sam mówił (koniec roku, z zapasem). **📅 DATA WYMIANY: luty/marzec 2023** (Michał, 09.09.2026: „trzy lata minęły w lutym albo marcu tego roku"). **Dziś to 3,5 roku, nie 3.**

**Przebieg od wymiany — SZACUNEK z map, nie z licznika: ~38–48 tys. km:**
| Kto | Okres | km |
|---|---|---|
| Tata Kingi — Koszarawa↔Żywiec | ~32 km/dzień × ~240 dni × ~2,8 roku | ~21 500 |
| Tata Kingi — 4× Koszarawa→Slagelse (DK) i z powrotem | ~1 300–1 400 km w jedną stronę (Żywiec→Berlin ~600, Berlin→Hamburg ~290, Hamburg→Slagelse ~460) = ~2 700/wyjazd | ~10 800 |
| Jego weekendy i sprawunki | niepoliczalne | +5–10 tys. |
| **Michał** | 424 000 → 430 000 | **6 000** |

**🔴 WNIOSEK — decyduje CZAS, nie kilometry:** na osi km jest połowa interwału (90–120 tys.), ale limit czasowy VW dla MY2004+ to **48 miesięcy** → **rozrząd dobija do terminu w LUTYM–MARCU 2027**.
- **Przed Bałkanami X.2026 — NIE ruszamy.** Pół roku zapasu
...
2. **Oględziny paska 17.09** — zdjąć osłonę, szukać: pęknięć na grzbietach zębów, wystrzępionych krawędzi, wygładzonej lśniącej powierzchni. To jedyna rzecz, która bije wszelkie wyliczenia z tabeli

**🟠 WAŻNE — robić, jeśli budżet pozwala**

| Pozycja | Dlaczego |
|---|---|
| **Pasek wielorowkowy + napinacz** | I tak podejrzany przy wspomaganiu; zerwany na trasie = brak ładowania i wspomagania naraz |
| **Wspomaganie: zlanie, przepłukanie, płyn VW G 002 000** | Recepta mechanika, kupujemy w całości |
...
**🔁 Kolejność decyzji o rozrządzie i głowicy — nie mylić kierunku:**
- Rozrząd: **NIE przed każdą trasą** (wcześniejszy zapis był bez sensu). Robisz go, gdy dobija do interwału — u Michała najpewniej koniec 2026 r.
- **Jeśli** głowica i tak schodzi → rozrząd wchodzi w tę samą robociznę i faktycznie oszczędzasz
- **Ale nie odwrotnie** — nie zdejmuj głowicy dlatego, że należy się pasek

**🔎 Jak potwierdzić uszczelkę, skoro tester bywa ślepy** (brat Michała miał fałszywy negatyw na pękniętej głowicy):
1. **Test CO2 zaraz po ostrym przejeździe**, na gorącym i przegazowywanym silniku — spaliny rozpuszczają się w płynie, na spokojnie rozgrzanym aucie może nie być czego wykryć. **Powtórzyć po tygodniu**
2. **Test ciśnienia 1,4 bar** (pompka, 15–30 min) — spada, a na zewnątrz nie kapie → leci do cylindra. Inne pytanie, ta sama odpowiedź
3. **Leak-down** — to NIE jest egzotyka: sprężarka + przejściówka w otwór po świecy żarowej, każdy warsztat ma. **Jedyny test odróżniający głowicę 3–4 tys. od chłodnicy EGR 600–1 500.** Upomnieć się 17.09
4. **Obserwacja po wymianie płynu** — czy świeży ciemnieje, czy poziom spada. 0 zł
...
**Dopisek od 07.09.2026 — do tej samej wizyty:**
> "Do tego zaczyna mi wysiadać pompa wspomagania — zerknąłbyś przy okazji? Ale najpierw uszczelka, przyjadę na zimnym."

⚠️ **Auto przyjeżdża ZIMNE** — inaczej pakiet uszczelkowy do powtórzenia następnego dnia, a pompa i tak poczeka.
